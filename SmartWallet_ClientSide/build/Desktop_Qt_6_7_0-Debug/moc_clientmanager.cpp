...
void ClientManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->dataRecieved((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        ...
        }
        {
            ...
            if (_t _q_method = &ClientManager::dataRecieved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void ClientManager::dataRecieved(QByteArray _t1)
{
